...
constexpr std::size_t kGuessLetterFeatureCount = kGuessLetterCount * kAlphabetSize;
constexpr std::size_t kFeedbackFeatureCount = kFeedbackCount * kTileStateCount;
constexpr std::size_t kTurnFeatureCount = kGuessLetterFeatureCount + kFeedbackFeatureCount;
